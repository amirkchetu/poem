$j(document).ready(function() {
    ...
    function disableFields(flag) {
        var fieldsArray = ['payment_shift4_payment_use_utg', 'payment_shift4_payment_server_addresses', 'payment_shift4_payment_auth_token'];
    ...
    $j("#payment_shift4_payment p.note").append("&nbsp;");
    $j("#payment_shift4_payment p.note").addClass("collapse");
    $j("#payment_shift4_payment p.note").removeClass("note");
    $j("#payment_shift4_payment p.collapse").children("span").hide();

    $j("#payment_shift4_payment p.collapse").click(function(e) {
        if (e.target != this)
            return;
